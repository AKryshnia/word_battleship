...
class WordBattleThemeTokens extends ThemeExtension<WordBattleThemeTokens> {
  ...
  static const fluffy = WordBattleThemeTokens(
    ...
    surface: Color(0xFFFFFFFF),
    surface2: Color(0xFFFDECF3),
    surface3: Color(0xFFF6DCE9),
    border: Color(0xFFF2CFDF),
    borderSubtle: Color(0xFFFCE5EF),
    borderStrong: Color(0xFFE6AFC9),
    text1: Color(0xFF4A1E33),
    text2: Color(0xFF7A425C),
    text3: Color(0xFF8F6579),
    accent: Color(0xFFE6478E),
    accentHover: Color(0xFFCE2F7A),
    accentPressed: Color(0xFFA3245E),
    accentFaint: Color(0x17E6478E),
    accentMid: Color(0x2EE6478E),
    accentGlow: Color(0x38E6478E),
    amber: Color(0xFFD48A20),
    red: Color(0xFFD63E5C),
    green: Color(0xFF2DAE74),
    onAccent: Color(0xFFFFFFFF),
    eventStripBackground: Color(0xFFFFFFFF),
    eventStripBorder: Color(0xFFFCE5EF),
    eventMissBar: Color(0xFFA8CCEA),
    eventMissLabel: Color(0xFF3A6FA0),
    eventHitBar: Color(0xFFE6478E),
    eventHitLabel: Color(0xFF8A1E52),
    eventSunkBar: Color(0xFFB81B6F),
    eventSunkLabel: Color(0xFF7A0F48),
    eventWonBar: Color(0xFF2DAE74),
    eventWonLabel: Color(0xFF186A4A),
    eventMessage: Color(0xFF2A1522),
    moveLogBackground: Color(0xFFFFFFFF),
    moveLogBorderTop: Color(0xFFFCE5EF),
    moveLogHeader: Color(0xFF8F6579),
    moveLogMissChipBackground: Color(0xFFFFF5F9),
    moveLogMissChipBorder: Color(0xFFF2CFDF),
    moveLogMissChipText: Color(0xFF7A425C),
