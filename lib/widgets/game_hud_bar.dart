...
// ─────────────────────────────────────────────────────────────────────────────
// Style picker — palette icon that opens a compact popup menu listing the
// 4 visual styles. Current selection is shown with a check; tapping any
...
class _StyleMenuRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        // Mini swatch — 3 sample cells (default · hit · miss) on the mat color.
